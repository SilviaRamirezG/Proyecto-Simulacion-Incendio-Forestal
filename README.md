...
3. ¿Qué ocurre con el tamaño medio de los incendios si aumentas p manteniendo f 
...
4. El parámetro size que se pasa al crear la simulación debe ser un entero entre 20 y 
...
5. El proyecto se gestiona con uv y pyproject.toml. ¿Qué ventaja tiene este enfoque 
